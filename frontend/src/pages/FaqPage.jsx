...
const FaqPage = () => {
    ...
    return (
        <div style={{ border: '2px solid #405c9c' }} className=" bg-white w-[800px] h-[1100px]">
            {/* Encabezado */}
            ...
            <div className=" flex flex-col items-center justify-center w-[800px] h-[900px]">
                ...
                <div style={{ border: '2px solid #405c9c' }} className="text-clickable w-[600px] mt-3" onClick={() => toggleContent(1)}>
            ...
            <div className="flex flex-col items-center justify-center mt-5">
                <div className="space-x-5">
                    <Link className="text-blue-800">about</Link>
                    <Link className="text-blue-800">contact</Link>
                    <Link className="text-blue-800">faq</Link>
